...
// // routines called by fpmc 
 ...
 void resonances2_sqme_aaaa_c_(double *_amp2, double *_s, double *_t,
   ...
   //Spin0even neutral resonances
 void resonances0even_sqme_gluglu_c__(double *_amp2, double *_s, double *_t,
                                    int *_exclude_loops_SM, int *_exclude_loops_EX,
                                    double *_m, double *_c, double *_cg, double *_w_c, double *_aa);

 void resonances0even_sqme_gluglu_c_(double *_amp2, double *_s, double *_t,
                                    int *_exclude_loops_SM, int *_exclude_loops_EX,
                                    double *_m, double *_c, double *_cg, double *_w_c, double *_aa);

   //Spin0even neutral resonances
 void resonances0even_sqme_hh_c__(double *_amp2, double *_s, double *_t,
                                    int *_exclude_loops_SM, int *_exclude_loops_EX,
                                    double *_m, double *_c, double *_ch, double *_w_c, double *_aa);

 void resonances0even_sqme_hh_c_(double *_amp2, double *_s, double *_t,
                                    int *_exclude_loops_SM, int *_exclude_loops_EX,
                                    double *_m, double *_c, double *_ch, double *_w_c, double *_aa);
 ...
 void eft_sqme_aaaz_c__(double *_amp2, double *_s, double *_t,
                        int *_exclude_loops_SM, double *_z1, double *_z3, double *_cutoff);

 void eft_sqme_aaaz_c_(double *_amp2, double *_s, double *_t,
                        int *_exclude_loops_SM, double *_z1, double *_z3, double *_cutoff);


 //Spin0even neutral resonances
 void resonances0evenoh_sqme_zz_c__(double *_amp2, double *_s, double *_t,
                                    int *_exclude_loops_SM, int *_exclude_loops_EX,
                                    double *_m, double *_c, double *_ch, double *_w_c, double *_aa);

 void resonances0evenoh_sqme_zz_c_(double *_amp2, double *_s, double *_t,
                                    int *_exclude_loops_SM, int *_exclude_loops_EX,
                                    double *_m, double *_c, double *_ch, double *_w_c, double *_aa);
// Dark Matter 
void dm_sqme_dm_c__(double *_amp2, double *_s, double *_t, 
		double *_mw, double *_m, double *_L, double *_c);

void dm_sqme_dm_c_(double *_amp2, double *_s, double *_t, 
                double *_mw, double *_m, double *_L, double *_c);
 #ifdef __cplusplus
 }
 #endif
...
void resonances0even_sqme_gluglu_c__(double *_amp2, double *_s, double *_t,
    ...
    resonances0even_sqme_gluglu_c_(_amp2, _s, _t, _exclude_loops_SM, _exclude_loops_EX, _m, _c, _cg, _w_c, _aa);
 }
...
//////////////////////////////////////////////////////////////////// 
   ...
   double amp2 = resonances0even_gluglu::sqme(*_s, *_t, *_exclude_loops_SM, *_exclude_loops_EX, *_m, *_c, *_cg, *_w_c, *_aa);
   *_amp2 = amp2;
}
...
void resonances0even_sqme_hh_c__(double *_amp2, double *_s, double *_t,
    ...
    resonances0even_sqme_hh_c_(_amp2, _s, _t, _exclude_loops_SM, _exclude_loops_EX, _m, _c, _ch, _w_c, _aa);
 }
...
// including interferences with SM
////////////////////////////////////////////////////////////////////
   double amp2 = resonances0even_hh::sqme(*_s, *_t, *_exclude_loops_SM, *_exclude_loops_EX, *_m, *_c, *_ch, *_w_c, *_aa);
   *_amp2 = amp2;
} 
...
void resonances0evenoh_sqme_zz_c__(double *_amp2, double *_s, double *_t,
    ...
    resonances0evenoh_sqme_zz_c_(_amp2, _s, _t, _exclude_loops_SM, _exclude_loops_EX, _m, _c, _ch, _w_c, _aa);
 }
...
//////////////////////////////////////////////////////////////////// 
   ...
   double amp2 = resonances0evenoh_zz::sqme(*_s, *_t, *_exclude_loops_SM, *_exclude_loops_EX, *_m, *_c, *_ch, *_w_c, *_aa);
   *_amp2 = amp2;
}
...
//wrapper for g77, EFT AA->AZ
void eft_sqme_aaaz_c__(double *_amp2, double *_s, double *_t,
                   int *_exclude_loops_SM, double *_z1, double *_z3, double *_cutoff) {

    eft_sqme_aaaz_c_(_amp2, _s, _t, _exclude_loops_SM, _z1, _z3, _cutoff);
 }
...
//////////////////////////////////////////////////////////////////// 
  ...
  double amp2 = eft_aaaz::sqme(*_s, *_t, *_exclude_loops_SM, a1a, a3a);
  *_amp2 = amp2;
}      
...
void dm_sqme_dm_c__(double *_amp2, double *_s, double *_t, 
     ...
     dm_sqme_dm_c_(_amp2, _s, _t, _mw, _m, _L, _c);
 }

void  dm_sqme_dm_c_(double *_amp2, double *_s, double *_t, 
                double *_mw, double *_m, double *_L, double *_c) {
//////////////////////////////////////////////////////////////////// 
// dm dm  with exotic fermions of mass m  cutoff L coupling c
// including interference with SM (SM fermion loops excluded is default)
//////////////////////////////////////////////////////////////////// 

   double amp2 = dm_dm::sqme( *_s, *_t, 
                 *_mw, *_m, *_L, *_c);
   *_amp2 = amp2;
}
