...
c---FFC default initialiszation
      ...
      UAAF0G     =    0.    !C Baldenegro 05-2016 Spin-0 to Gluon coupling
      UAAF0H     =    0.    !C Baldenegro 05-2016 Spin-0 to HH coupling
      UAAW       =    0.
      UAAA2      =    0.
      UQ2WWMN    =    0.
      UQ2WWMX    =    4.
      ...
      IF(READCARD) THEN
        ...
        call FFKEY('AAMW', UAAMW,1,'real')
        call FFKEY('AAL', UAAL,1,'real')
        call FFKEY('AAC', UAAC,1,'real')       
	 call FFKEY('AAQ', UAAQ,1,'real')
        call FFKEY('AAN', UAAN,1,'real')
        call FFKEY('AAF0', UAAF0,1,'real')
	call FFKEY('AAF0Z', UAAF0Z,1,'real')
	call FFKEY('AAF0G', UAAF0G,1,'real')
	call FFKEY('AAF0H', UAAF0H,1,'real')
